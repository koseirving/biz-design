        ...
        {profiles.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {profiles.map((profile) => (
              <div key={profile.id} className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
                ...
                <div className="space-y-2">
                  {profile.profile_data?.size && (
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="text-gray-700 dark:text-gray-300">{profile.profile_data.size}</span>
                    </div>
                  )}
                  {profile.profile_data?.revenue && (
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-500 dark:text-gray-400">Revenue:</span>
                      <span className="text-gray-700 dark:text-gray-300">{profile.profile_data.revenue}</span>
                    </div>
                  )}
                </div>
